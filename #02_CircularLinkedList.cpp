/* __________________________________________Question.1___________________________________________ 
...
/*___________________________________________Question.2]________________________________________________  
...
>>Fionacci Heap: Circular Linked List is also used in the implementation of advanced data structures such as a Fibonacci Heap.
>>Computer Networking:Circular linked list is also used in computer networking for token scheduling.
>>Implementation of Data Structure: Data structures such as stacks and queues are implemented with the help of the circular linked lists.
>>Audio/Video Streaming: Circular linked list is also used in audio and video streaming,for ex. when one copmlete audio list finishes playing in music player then it again starts playing from start.
*/
